...
for ind in range(0,numPortfolios):
    niftyWeight.append(sharpeAndWeight[ind][1][0])
    momentumWeight.append(sharpeAndWeight[ind][1][1])
    goldWeight.append(sharpeAndWeight[ind][1][2])
